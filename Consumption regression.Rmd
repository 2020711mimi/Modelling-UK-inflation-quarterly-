---
title: "Model Consumption and CPI"
author: "Yiyi"
date: "`r Sys.Date()`"
output:
...
```{r llagugage, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
Sys.setlocale("LC_TIME","English")
```
...
#替换名称
search_for_these <- c("lag1[, x]","lag2[, x]","lag3[, 1]","lag4[, x]","lag5[, x]","lag6[, x]","lag7[, x]","lag8[, x]","lag9[, x]","lag10[, x]","lag11[, x]","lag12[, 1]")

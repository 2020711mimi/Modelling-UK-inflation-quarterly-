...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{theme}\NormalTok{(}\AttributeTok{legend.title =} \FunctionTok{element\_blank}\NormalTok{()) }
\end{Highlighting}
\end{Shaded}
...
\end{verbatim}
  ...
  \includegraphics{trimmed-mean_files/figure-latex/unnamed-chunk-7-1.pdf}
\end{enumerate}

...
stargazer(model.div,
          ...
          flip = FALSE,
          se = NULL,
          out = "output, unemployment, PPI and hourly wages/div aggregate P.html",
          type = "text"
)   
...
modelsummary(
  ...
  fmt = "%.2f",
  coef_omit = "Intercept",
  output = "output, unemployment, PPI and hourly wages/div aggregate.html"
)
...
modelsummary(
  ...
  fmt = "%.2f",
  coef_omit = "Intercept",
  output = "output, unemployment, PPI and hourly wages/div AIC.html"
)
...
stargazer(y.list1,
          ...
          flip = FALSE,
          se = NULL,
          out = "output, unemployment, PPI and hourly wages/div AIC P.html",
          type = "text"
)   

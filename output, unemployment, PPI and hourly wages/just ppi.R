...
stargazer(model.div,
          ...
          flip = FALSE,
          se = NULL,
          out = "12 lag unemploy wage ppi/just ppi",
          type = "text"
)   
...
modelsummary(
  ...
  fmt = "%.2f",
  coef_omit = "Intercept",
  output = "output, unemployment, PPI and hourly wages/just ppi.html"
)
...
modelsummary(
  ...
  fmt = "%.2f",
  coef_omit = "Intercept",
  output = "output, unemployment, PPI and hourly wages/ppi AIC.html"
)
...
stargazer(y.list1,
          ...
          flip = FALSE,
          se = NULL,
          out = "output, unemployment, PPI and hourly wages/ppi AIC P.html",
          type = "text"
)   

...
stargazer(model.div,
          ...
          flip = FALSE,
          se = NULL,
          out = "output, unemployment, PPI and hourly wages/just unemploy P.html",
          type = "text"
)   
...
modelsummary(
  ...
  fmt = "%.2f",
  coef_omit = "Intercept",
  output = "output, unemployment, PPI and hourly wages/just unemploy.html"
)
...
modelsummary(
  ...
  fmt = "%.2f",
  coef_omit = "Intercept",
  output = "output, unemployment, PPI and hourly wages/unemploy AIC.html"
)
...
stargazer(y.list1,
          ...
          flip = FALSE,
          se = NULL,
          out = "output, unemployment, PPI and hourly wages/unemploy AIC P.html",
          type = "text"
)   

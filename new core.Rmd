---
title: "new EVALUATING  CORE INFLATION MEASURES"
author: "Yiyi"
date: "`r Sys.Date()`"
output:
...
sticky_new<- fread("sticky price/sticky CPI.csv")
sticky_06_19$sticky_core_inflation <- sticky_new$x
```
...
SP<-ggplot(data=CPI519, aes(x=time(nt)))+
 geom_line(aes(y =Sticky, color="Sticky CPI")) +
   geom_line(aes(y = CPI, color="CPI inflation")) +
labs(x="Time",y="Inflation")
SP + theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
```
\newpage

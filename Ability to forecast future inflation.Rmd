...
Next, I looked up the monthly CPI index and weight for sticky price items based on their ID one by one for the years 2005 to 2021.
...
rowSums(www)
wowrite.csv(www,"sticky CPI weight new.csv")
```
